...
$(".fullSlide").slide({
    ...
    function createMap(){
        ...
        var point = new BMap.Point(106.554588,29.567862);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"重庆汉沙科技有限公司",content:"重庆汉沙科技有限公司",point:"106.552657|29.566339",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
